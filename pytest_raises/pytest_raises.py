...
def pytest_runtest_call(item):
    ...
    if hasattr(item, 'get_closest_marker'):
        marker_get_func = item.get_closest_marker
    else:
        marker_get_func = item.get_marker
            ...
            if message is not None:
                try:
                    ...
                    if message not in raised_message:
                        raise ExpectedMessage('"{}" not in "{}"'
                                              .format(message, raised_message))
